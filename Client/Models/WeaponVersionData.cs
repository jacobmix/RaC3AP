...
namespace RaC3AP.Models
{
    public class WeaponVersionData
    {
        ...
        public const int ADDexpShockBlaster = 0x20142E7C + AddressOffset;
        public const int ADDexpNitroLauncher = 0x20142FBC + AddressOffset;
        public const int ADDexpN60Storm = 0x20142E9C + AddressOffset;
        public const int ADDexpPlasmaWhip = 0x20142FDC + AddressOffset;
        public const int ADDexpInfector = 0x20142EBC + AddressOffset;
        public const int ADDexpSuckCannon = 0x20142FFC + AddressOffset;
        public const int ADDexpSpittingHydra = 0x20142EFC + AddressOffset;
        public const int ADDexpAgentsOfDoom = 0x20142F3C + AddressOffset;
        public const int ADDexpFluxRifle = 0x20142F9C + AddressOffset;
        public const int ADDexpAnnihilator = 0x20142EDC + AddressOffset;
        public const int ADDexpHoloShieldGlove = 0x20142F7C + AddressOffset;
        public const int ADDexpDiskBladeGun = 0x20142F1C + AddressOffset;
        public const int ADDexpRiftInducer = 0x20142F5C + AddressOffset;
        public const int ADDexpQwackORay = 0x2014301C + AddressOffset;
        public const int ADDexpRY3N0 = 0x2014303C + AddressOffset;
        public const int ADDexpMegaTurretGlove = 0x20142E34 + AddressOffset;
        public const int ADDexpLavaGun = 0x20142E24 + AddressOffset;
        public const int ADDexpShieldCharger = 0x20142E38 + AddressOffset;
        public const int ADDexpBouncer = 0x20142E2C + AddressOffset;
        public const int ADDexpPlasmaCoil = 0x20142E20 + AddressOffset;
        ...
        public const int ADDversionShockBlaster = 0x201425E7 + AddressOffset;
        public const int ADDversionNitroLauncher = 0x20142637 + AddressOffset;
        public const int ADDversionN60Storm = 0x201425EF + AddressOffset;
        public const int ADDversionPlasmaWhip = 0x2014263F + AddressOffset;
        public const int ADDversionInfector = 0x201425F7 + AddressOffset;
        public const int ADDversionSuccCannon = 0x20142647 + AddressOffset;
        public const int ADDversionSpittingHydra = 0x20142607 + AddressOffset;
        public const int ADDversionAgentsOfDoom = 20142617 + AddressOffset;
        public const int ADDversionFluxRifle = 0x2014262F + AddressOffset;
        public const int ADDversionAnnihilator = 0x201425FF + AddressOffset;
        public const int ADDversionHoloShieldGlove = 0x20142627 + AddressOffset;
        public const int ADDversionDiskBladeGun = 0x2014260F + AddressOffset;
        public const int ADDversionRiftInducer = 0x2014261F + AddressOffset;
        public const int ADDversionQwackORay = 0x2014264F + AddressOffset;
        public const int ADDversionRY3N0 = 0x20142657 + AddressOffset;
        public const int ADDversionMegaTurretGlove = 0x201425D5 + AddressOffset;
        public const int ADDversionLavaGun = 0x201425D1 + AddressOffset;
        public const int ADDversionShieldCharger = 0x201425D6 + AddressOffset;
        public const int ADDversionBouncer = 0x201425D3 + AddressOffset;
        public const int ADDversionPlasmaCoil = 0x201425D0 + AddressOffset;
